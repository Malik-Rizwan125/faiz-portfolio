...
const baseStyles: Record<HeadingVariant, string> = {
  h1: "text-[32px] lg:text-[40px] 2xl:text-[50px] leading-[36px] md:leading-[40px] lg:leading-[60px] font-semibold text-text-primary break-normal whitespace-normal",
  h2: "text-[32px] lg:text-[40px] 2xl:text-[50px] leading-[36px] md:leading-[40px] lg:leading-[60px] font-semibold text-text-primary break-normal whitespace-normal",
  ...
  h5: "text-[14px] md:text-[15px] xl:text-[18px] font-medium !text-[#E12CEC] leading-[22px] sm:leading-[30px] break-normal whitespace-normal",
